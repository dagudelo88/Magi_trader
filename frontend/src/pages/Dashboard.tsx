...
export default function Dashboard() {
  const [btcTick, setBtcTick] = useState<{ price: number, time: Date } | undefined>();
  ...
  return (
    <main className="flex-1 flex overflow-hidden p-6">
      <div className="w-full h-full flex flex-col">
        ...
        <div className="flex-1 bg-panel border border-border p-4 rounded-custom overflow-hidden">
          <TradingChart symbol="BTCUSDT" latestTick={btcTick} />
        </div>
      </div>
    </main>
  );
